...
description: "¿Qué universidad forma más talento para la NBA? Nueve programas de la NCAA compiten en seis rondas según los picks del Draft: minutos, valoración, TS % y más."
...
heroAlt: "Ilustración de analistas con portátiles y jugadores universitarios junto a paneles de gráficos con el texto «Draft Analysis»"
...
![Clasificación inicial de las nueve universidades, todas con cero puntos antes de la primera ronda](../../assets/blog/en-busca-de-la-fabrica-de-talento-analisis-de-los-picks-del-draft-de-distintas-universidades-de-la-ncaa/tablaequiposronda0-3.jpg)

*Clasificación inicial*

## **Ronda 1: Jugadores drafteados en 1a ronda**

![Mapa de calor con el número de jugadores de cada universidad elegidos en la primera ronda del Draft de la NBA](../../assets/blog/en-busca-de-la-fabrica-de-talento-analisis-de-los-picks-del-draft-de-distintas-universidades-de-la-ncaa/round-1.png)
...
![Clasificación de las nueve universidades tras la ronda 1 (jugadores drafteados en primera ronda)](../../assets/blog/en-busca-de-la-fabrica-de-talento-analisis-de-los-picks-del-draft-de-distintas-universidades-de-la-ncaa/tablaequiposronda1.jpg)
...
![Gráfico con los minutos totales disputados en la NBA por los jugadores drafteados de cada universidad](../../assets/blog/en-busca-de-la-fabrica-de-talento-analisis-de-los-picks-del-draft-de-distintas-universidades-de-la-ncaa/round-2.png)
...
![Clasificación de las nueve universidades tras la ronda 2 (minutos totales disputados)](../../assets/blog/en-busca-de-la-fabrica-de-talento-analisis-de-los-picks-del-draft-de-distintas-universidades-de-la-ncaa/tablaequiposronda2.jpg)
...
![Gráfico de barras apiladas con la valoración media por partido de los jugadores drafteados de cada universidad: Duke 7,928, Kentucky 7,912 y Washington 7,200 lideran](../../assets/blog/en-busca-de-la-fabrica-de-talento-analisis-de-los-picks-del-draft-de-distintas-universidades-de-la-ncaa/round-3.png)
...
![Clasificación de las nueve universidades tras la ronda 3: Kentucky 26 puntos, Duke 25 y Washington 19](../../assets/blog/en-busca-de-la-fabrica-de-talento-analisis-de-los-picks-del-draft-de-distintas-universidades-de-la-ncaa/tablaequiposronda3.jpg)
...
![Gráfico con la valoración defensiva media de los jugadores drafteados de cada universidad](../../assets/blog/en-busca-de-la-fabrica-de-talento-analisis-de-los-picks-del-draft-de-distintas-universidades-de-la-ncaa/round-4.png)
...
![Clasificación de las nueve universidades tras la ronda 4 (valoración defensiva media)](../../assets/blog/en-busca-de-la-fabrica-de-talento-analisis-de-los-picks-del-draft-de-distintas-universidades-de-la-ncaa/tablaequiposronda4.jpg)
...
![Gráfico con el TS % medio de los jugadores drafteados de cada universidad](../../assets/blog/en-busca-de-la-fabrica-de-talento-analisis-de-los-picks-del-draft-de-distintas-universidades-de-la-ncaa/round-5.png)
...
![Clasificación de las nueve universidades tras la ronda 5 (TS % medio)](../../assets/blog/en-busca-de-la-fabrica-de-talento-analisis-de-los-picks-del-draft-de-distintas-universidades-de-la-ncaa/tablaequiposronda5.jpg)
...
![Gráfico con los jugadores de cada universidad que han entrado en el Hall of Fame](../../assets/blog/en-busca-de-la-fabrica-de-talento-analisis-de-los-picks-del-draft-de-distintas-universidades-de-la-ncaa/round-6.png)
...
![Clasificación final de las nueve universidades tras la ronda 6 (Hall of Fame)](../../assets/blog/en-busca-de-la-fabrica-de-talento-analisis-de-los-picks-del-draft-de-distintas-universidades-de-la-ncaa/tablaequiposronda6.jpg)
